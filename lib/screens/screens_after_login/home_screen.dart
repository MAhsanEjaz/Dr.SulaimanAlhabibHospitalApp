...
import 'package:web_practice/screens/screens_after_login/covid_19_screen.dart';
...
import 'package:web_practice/screens/screens_after_login/to_do_list_screen.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            IconWithTextCard(
                                text: 'Height CM', iconData: Icons.height),
                            IconWithTextCard(
                                text: 'Weight Kg', iconData: Icons.line_weight),
                            IconWithTextCard(
                              text: 'Blood Type',
                              iconData: Icons.bloodtype,
                            ),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                              builder: (context) => const HmgViewAllScreen()));
                    },
                    child: const Text(
                      'View All Services',
                      style: TextStyle(
                    ...
                    HomeScreenHmgCard(
                      ...
                      onTap: () {
                        PageNavigationService()
                            .pageNavigation(context, CovidScreen());
                        // covid19Dialog(context);
                      },
                      text2: 'Test',
                    ),
